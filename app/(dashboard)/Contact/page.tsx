...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 pt-32 pb-24 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        
        {/* Editorial Header Section */}
        <div className="max-w-3xl space-y-4 p-10" data-aos="fade-up">
          <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8" data-aos="fade-right">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
              ...
              {/* Phone Card */}
              <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200/80 dark:border-slate-800/80 space-y-2 transition-colors">
                ...
                <Link href="tel:+97167434537" className="text-lg font-semibold text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition inline-flex items-center gap-1">
                  +971 6 743 4537 <ArrowUpRight className="w-4 h-4" />
                </Link>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200/80 dark:border-slate-800/80 space-y-2 transition-colors">
                ...
                <Link href="mailto:info@drchiller.com" className="text-lg font-semibold text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition inline-flex items-center gap-1">
                  info@drchiller.com <ArrowUpRight className="w-4 h-4" />
                </Link>
              </div>
          ...
          <div className="lg:col-span-7 space-y-8" data-aos="fade-left">
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-slate-50/50 dark:bg-slate-900/40 border border-slate-200/80 dark:border-slate-800/80 backdrop-blur-sm shadow-xs">
              
              <div className="mb-8 space-y-2">
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Send a Technical Inquiry</h2>
              ...
              {status === 'success' && (
                <div className="mb-6 p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-300 flex items-center gap-3 text-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm transition shadow-sm disabled:opacity-50 cursor-pointer"
                >
        ...
        <div className="p-4 sm:p-6 rounded-3xl bg-slate-50/50 dark:bg-slate-900/40 border border-slate-200/80 dark:border-slate-800/80 space-y-4" data-aos="fade-up">
          ...
          <div className="relative w-full h-112.5 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
            <iframe
