...
export default function CardImage({
  ...
  return (
    <Card className="relative mx-auto flex flex-col justify-between h-full w-full max-w-sm overflow-hidden pt-0 shadow-sm transition-shadow hover:shadow-md">
  {/* Top Section Wrapper */}
  <div>
    {/* Container for the image */}
    <div className="group relative aspect-video w-full overflow-hidden bg-muted transform-gpu">
      <Image
        src={imageSrc}
